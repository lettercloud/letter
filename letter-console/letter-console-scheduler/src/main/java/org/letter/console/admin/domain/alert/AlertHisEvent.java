...
@Setter
@Entity
@Table(name = "alert_his_event")
public class AlertHisEvent  extends BaseEntity implements Serializable {
    ...
    @Column(name = "recover_time", nullable = false)
    private Long recoverTime;

    @Column(name = "last_eval_time", nullable = false)
