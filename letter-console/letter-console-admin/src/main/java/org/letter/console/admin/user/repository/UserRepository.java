package org.letter.console.admin.user.repository;
...
public interface UserRepository extends JpaRepository<User, Long>, JpaSpecificationExecutor<User> {
	...
	@Modifying
	@Transactional
	@Query(value = "update c_users set password = ?2 , pwd_reset_time = ?3 where username = ?1", nativeQuery = true)
	 ...
	 */
	@Modifying
	@Query(value = "update c_users set email = ?2 where username = ?1", nativeQuery = true)
	 ...
	 */
	@Modifying
	@Query(value = "update c_users set password = ?2 where user_id in ?1", nativeQuery = true)
...
//     * @return /
//     */
//    @Query(value = "SELECT u.* FROM c_users u, c_role r WHERE" +
...
//     * @return /
//     */
//    @Query(value = "SELECT u.* FROM c_users u, sys_users_roles r, sys_roles_depts d WHERE " +
