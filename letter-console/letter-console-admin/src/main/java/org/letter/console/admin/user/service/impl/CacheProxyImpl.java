...
public class CacheProxyImpl implements CacheProxy {
	private static final Logger log = LoggerFactory.getLogger(CacheProxyImpl.class);

	private RedisTemplate<Object, Object> redisTemplate;

	public CacheProxyImpl(RedisTemplate<Object, Object> redisTemplate) {
	...
	public void delByKeys(String prefix, Set<Long> ids) {
		try {
			...
			// 此处提示可自行删除
			log.debug("--------------------------------------------");
			log.debug("delete cache：" + keys.toString());
			log.debug("delete cache count：" + count + "个");
			log.debug("--------------------------------------------");
		} catch (Exception e) {
			log.error(prefix, e);
		}
