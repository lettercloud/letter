...
public class TokenProviderServiceImpl implements TokenProviderService {
	...
	public TokenProviderServiceImpl(SecurityProperties properties, CacheProxy cacheProxy) {
	...
	public void checkRenewal(String token) {
		...
		long time = cacheProxy.getExpire(loginKey) * 1000;
		...
		if (differ <= properties.getDetect()) {
			...
			cacheProxy.expire(loginKey, renew, TimeUnit.MILLISECONDS);
		}
	}
